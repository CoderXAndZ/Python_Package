...
def create_window():
    ...
    tk.Button(root, text="开始打包", command=lambda: judgePath(excelFile.get(), projectFile.get(), outputPath.get(),
                                                           infoPlistPath.get())).grid(row=4, column=0, pady=10)
